...
This repository independently tracks the latest research on **machine learning and physics-informed methods applied to gas turbines and turbomachinery**. It covers **106 papers** across 6 categories.
